...
public class MenPDetail2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_men_pdetail2);
    ...
    private void addToCart() {
        Intent intent = new Intent(MenPDetail2.this, CartActivity.class);

        // Get product details
        String productName = "Nike Air Max"; // You can retrieve this dynamically
        int productQuantity = quantity; // Assuming you've stored the quantity
        double productPrice = 35.0;
        int productImageResId = R.drawable.product2;
